...
public class PiadaService {
    ...
    private void popularPiadas() {
        ...
        piadas.add(new Piada(3,"O que o m.m.c estava fazendo em baixo da escada? Esperando o m.d.c."));
        piadas.add(new Piada(4,"O que acontece se esfregar uma lâmpada mágica em baixo d'água? Aparece um hidrogênio"));        
    }
}
